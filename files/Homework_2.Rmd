...
After implementing multimensional scaling, the corresponding points to each gesture is plotted on the graph. This does not create a useful way to separate gestures. For example, even though gestures 1 and 5 are distinguishable, gestures 1 and 6 are almost indistinguishable.
...
ggplot(fit_data) + geom_point(aes(x=coord1, y=coord2, colour=Classes)) + xlab("Time Index") + ylab("Value") + theme(plot.title=element_text(hjust = 0.5)) + ggtitle("MDS") 
